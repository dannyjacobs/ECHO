...
compared_model = '/home/echo/Downloads/BicoLog_anker_valon_ff137.fits'
...
#get the model to compare to
compared_map = read_map(compared_model)
compared_map -= np.mean(compared_map[:3])
compared_slice_E = get_interp_val(compared_map,alt,az)
compared_slice_H = get_interp_val(compared_map,alt,az+np.pi/2)
...
axarr[0,1].plot(alt*180/np.pi,compared_slice_E,'-k',lw=2)
axarr[0,2].plot(alt*180/np.pi,base_slice_E-compared_slice_E,'-k',lw=2)
axarr[1,0].plot(alt*180/np.pi,base_slice_H,'-k',lw=2)
axarr[1,1].plot(alt*180/np.pi,compared_slice_H,'-k',lw=2)
axarr[1,2].plot(alt*180/np.pi,base_slice_H-compared_slice_H,'-k',lw=2)
#legend(loc='best')
axarr[0,0].set_title('Base')
axarr[0,1].set_title('Compared')
axarr[0,2].set_title('Base - Compared')
